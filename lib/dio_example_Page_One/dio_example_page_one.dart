...
import 'package:flutterdownloder_using/dio_example_Page_One/check_permission.dart';
import 'package:flutterdownloder_using/dio_example_Page_One/directory_path.dart';
import 'package:open_file_plus/open_file_plus.dart';

class DioUseExampleOne extends StatefulWidget {
  const DioUseExampleOne({super.key});

  @override
  State<DioUseExampleOne> createState() => _DioUseExampleOneState();
}

class _DioUseExampleOneState extends State<DioUseExampleOne> {
    ...
    return Scaffold(
        body: isPermission
            ...
            : TextButton(
                ...
                child: Center(child: const Text("Permission issue"))));
  }
}
...
class _TileListState extends State<TileList> {
  ...
  startDownload() async {
    ...
    var storePath = await getPathFile.getPath2();
